			...
			<div class="card o-hidden border-0 shadow-lg">
				<div class="card-body ">
					...
					<div class="row justify-content-center">
						<div class="col-lg-8">
							<div class="p-5">
								<form class="admin-form" action="{{ route('back.feature.store') }}" method="POST"
									...
									<div class="form-group">
                                        ...
                                        <div name="icon"  data-selected-class="btn-secondary" data-align="left" data-header="false" data-footer="false" data-search="true" data-rows="3" data-cols="17" data-search-text="{{ __('Search...') }}" role="iconpicker" data-icon="{{ old('icon') }}"></div>
